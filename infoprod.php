...
<table id="taula"> 
  <tr>
    ...
    <td><?php echo "<u>" . $row['Izena'] . "</u>" . "<br><br>" . $row['Azalpena'] . "<br><br>" . "Mota = " . $row['Mota']; ?></td>


<?php if ( isset($_SESSION["sesioaHasita"]) && $_SESSION["sesioaHasita"] == true)
			{


    echo '<td><form action="orgatxora_gehitu.php" method="post">
        Kantitatea: <input type="number" min="1" max="5" name="kantitatea" value="1" />
