...
<article>
		...
		<table id="taula">
			...
			<!-- taula batean produkten informazio guztia pantailaratuko dugu -->
  			<tr>
    			<td><?php echo "<a href='infoprod.php?id=".$row['Id']."'> <img src='./IRUDIAK/" . $row['Irudia'] . "' width='150'></img> </a>"; ?></td>
    			<td><?php echo "<a href='infoprod.php?id=".$row['Id']."'>" . "<u>" . $row['Izena'] . "</u>" . "</a>" . "<br><br>" . $row['Azalpena']; ?></td>
  			</tr>
