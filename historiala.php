...
$sql_erabiltzaile="SELECT Id, Izena, Pasahitza, Mota FROM erabiltzaileak;";

$result = $conn->query($sql_erabiltzaile);

//echo $sql_erabiltzaile;
...
<h1 class="izenburua"> Zure Historiala </h1>
...
$sql_historiala="SELECT * FROM eskaera_historiala WHERE erabiltzaileak_Id = $erabid;";

$result_historiala = $conn->query($sql_historiala);
...
<table id="taula"> 
  	<tr WIDTH="50" HEIGHT="50">
    	...
    	<th> Liburu Mota</th>
    	<th> Hasierako data</th>
    	<th> Bukaerako data</th>
    	<th> Kantitatea: </th>
  	</tr>
	<?php while ($row=$result_historiala->fetch_assoc()) { //$row erantzun bat ematen badigu... ?>
